export default function AdminPlaceholder({ params }: any) {
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-4">
            ...
            <h1 className="text-2xl font-bold text-slate-900">هذه الصفحة قيد التطوير</h1>
            <p className="text-slate-500 max-w-md">نعمل حالياً على بناء أدوات متقدمة للتحكم في هذا القسم. سيتم تفعيلها قريباً.</p>
        </div>
    );
}
